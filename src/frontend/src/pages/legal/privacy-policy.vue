<template>
  ...
  >
    <v-card
      ...
      tile
    >
      <v-card-title><h1>Privacy Policy</h1></v-card-title>
      <div class="date">
        <v-icon>mdi-calendar</v-icon>
        <span>Last Modified: Jan 21, 2021</span>
      </div>
      ...
      <ul>
        <li>
          This Privacy Policy (“Policy”) refers to Skeleton and you, the
          user of this site.
          <ul>
            <li>
      ...
      <p>
        ...
        information from children under the age of 13. Skeleton.com does
      ...
      <ul>
        <li>
          <b>Members</b> - Members are those users who subscribe to our services will be prompted to
          provide their name, their address, their age, their phone number, and any other necessary
          billing information.
        </li>
        <li>
          <b>Posters</b> - Posters are visitors to our SITE who choose to register to post information
        ...
        <li>
          <b>All SITE users and visitors</b> - We automatically collect the following information from
      ...
      <p>
        We and our third party service providers use cookies and other tracking mechanisms, including
      ...
      <ul>
        <li>
          <b>Cookies.</b> Cookies are alphanumeric identifiers that we transfer to your device’s hard
        ...
        <li>
          <b>Disabling Cookies.</b> Most web browsers automatically accept cookies, but if you prefer,
        ...
        <li>
          <b>Clear GIFs, pixel tags and other technologies.</b> Clear GIFs are tiny graphics with a
        ...
        <li>
          <b>Third Party Analytics.</b> We use automated devices and applications, such as Google
          ...
          experiences. These entities may use cookies and other tracking technologies to perform their
          ...
          being used by Google Analytics at <a href="https://tools.google.com/dlpage/gaoptout">https://tools.google.com/dlpage/gaoptout</a>.
        </li>
        <li>
          <b>Do-Not-Track.</b> Currently, our systems do not recognize browser “do-not-track”
        ...
        <li>
          <p>
            <b>Third-Party Ad Networks.</b> We use third parties such as network advertisers to
            ...
            providers, advertisers, sponsors and/or traffic measurement services may use cookies,
            JavaScript, web beacons (including clear GIFs), Flash LSOs and other tracking
            ...
            third party’s specific privacy policy, not this one. We may provide these third-party
          ...
          <p>
            ...
            may go to the Digital Advertising Alliance (“DAA”) <a href="http://www.aboutads.info/choices/">Consumer Choice Page</a> for
            information about opting out of interest-based advertising and their choices regarding
            having information used by <a href="http://www.aboutads.info/participating/">DAA
              companies</a>. You may also go to the Network Advertising Initiative (“NAI”) <a href="http://www.networkadvertising.org/choices/">Consumer Opt-Out Page</a> for
            information about opting out of interest-based advertising and their choices regarding
            having information used by <a href="http://www.networkadvertising.org/participating-networks">NAI members</a>.
          </p>
          Opting out from one or more companies listed on the DAA <a href="http://www.aboutads.info/choices/">Consumer Choice Page</a> or the NAI <a href="http://www.networkadvertising.org/choices/">Consumer Opt-Out Page</a> will opt
          ...
          effective. Additional information is available on the DAA’s website at <a href="http://www.aboutads.info/">www.aboutads.info</a> or the NAI’s website at <a href="http://www.networkadvertising.org/">www.networkadvertising.org</a>.
        </li>
      </ul>
      <h2>
      ...
      <ul>
        ...
        <li>
          To protect the safety, rights, property, or security of Skeleton, our
          ...
          that Skeleton, in its sole discretion, may consider to be, or to pose
          a risk of being, an illegal, unethical, or legally actionable activity; to use as evidence
          in litigation; to conduct audits; and to enforce this Policy, our Terms Of Use, and
      ...
      <ul>
        <li>
          <b>Forum Users.</b> If you create an account to use one of our forums, your forum
          profile, Skeleton directory information, and any information you post
          on one of our forums will be available to other forum users and all SITE visitors.
        </li>
        <li>
          <b>Affiliates.</b> We may disclose the information we collect from you to our affiliates or
          subsidiaries; however, if we do so, their use and disclosure of your personal information
          will be subject to this Policy.
        </li>
        <li>
          <b>Service Providers.</b> We may disclose the information we collect from you to third party
      ...
      <ul>
        <li>
          <b>Business Transfers.</b> If we are or may be acquired by or merged with another company,
        ...
        <li>
          <b>In Response to Legal Process.</b> We also may disclose the information we collect from
        ...
        <li>
          <b>To Protect Us and Others.</b> We also may disclose the information we collect from you
          ...
          person, violations of our Terms of Service, Terms Of Use, or this Policy, or as
          evidence in litigation in which Skeleton is involved.
        </li>
        <li>
          <b>Aggregate and De-Identified Information.</b> We may share aggregate or de-identified
      ...
      <ul>
        <li>
          <b>Public Forums</b> - Any information posted to a Forum should immediately be considered to
          be public information.
        </li>
        <li>
          <b>Member Directories</b> - Any information provided in a user profile, Member directory, or
        ...
        <li>
          <b>Internal Messaging</b> - We provide an internal messaging system for use between Members
      ...
      <p>
        ...
        at&nbsp;<a href="/home/contact/">Contact</a>
      </p>
      <h2>
        XI. Where to Direct Questions About Our Privacy Policy.
      </h2>
      <p>
        If you have any questions about this Policy or the practices described herein, you may contact
        us at&nbsp;<a href="/home/contact/">Contact</a>
      </p>
    </v-card>
  </v-container>
</template>
...
export default {
  ...
  layout: 'Home',
  mounted () {
    this.$store.dispatch('page/title', 'Privacy Policy')
  }
}
</script>
