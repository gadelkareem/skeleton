  ...
  >
    ...
    <v-row>
      ...
      >
        <v-card>
          <v-card-text>
            <subheading subheading="Collapsible Accordion" />
          ...
          >
            <v-tab-item>
              <v-card class="mt-0 px-5">
                <v-card-text>
                  <subheading subheading="Description about product">
            ...
            <v-tab-item>
              <v-card class="mt-0 px-5">
                <v-card-text>
                  <subheading subheading="Location of the product product">
                    <p class="grey--text body-2 font-weight-light">
                      More Information here
                    </p>
                  </subheading>
            ...
            <v-tab-item>
              <v-card class="mt-0 px-5">
                <v-card-text>
                  <subheading subheading="Legal info of the product product">
                    <p class="grey--text body-2 font-weight-light">
                      More Information here
                    </p>
                  </subheading>
            ...
            <v-tab-item>
              <v-card class="mt-0 px-5">
                <v-card-text>
                  <subheading heading="Help center">
                    <p class="grey--text body-2 font-weight-light">
                      More Information here
                    </p>
                  </subheading>
...
import MaterialTabs from '@@/components/base/MaterialTabs'
import VComponent from '@@/components/base/VComponent'
export default {
  name: 'DashboardPanels',
  components: { VComponent, MaterialTabs, Subheading },
  layout: 'Dashboard',
