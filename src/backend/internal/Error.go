...
var (
	...
	ErrSubscriptionNotUpdated          = Errorf(http.StatusBadRequest, "There was no changes to your subscription.")
	ErrUserHasActiveSubscriptions      = Errorf(http.StatusForbidden, "You have an active subscription. Please cancel your current subscription to be able to delete your account.")
