...
type (
    AuthToken struct {
        ID           int    `jsonapi:"primary,token-requests,omitempty" valid:"Numeric"`
    ...
    Login struct {
        ID         int    `jsonapi:"primary,login-requests,omitempty" valid:"Numeric"`
    ...
    VerifyEmail struct {
        ID    int    `jsonapi:"primary,email-verify-requests,omitempty" valid:"Numeric"`
        Email string `jsonapi:"attr,email" valid:"Required;Email;MaxSize(100)"`
        Token string `jsonapi:"attr,token" valid:"Required;Length(32)"`
    }
    VerifyMobile struct {
        ID   int    `jsonapi:"primary,mobile-verify-requests,omitempty" valid:"Numeric"`
        Code string `jsonapi:"attr,code" valid:"Required;Length(6)"`
    }
    ResetPassword struct {
        ID       int    `jsonapi:"primary,reset-password-requests,omitempty"  valid:"Numeric"`
        Email    string `jsonapi:"attr,email" valid:"Required;Email;MaxSize(100)"`
    ...
    UpdatePassword struct {
        ID          int    `jsonapi:"primary,update-password-requests,omitempty" valid:"Numeric"`
    ...
    SocialAuth struct {
        ID          int    `jsonapi:"primary,social-login-requests,omitempty" valid:"Numeric"`
    ...
    Authenticator struct {
        ID      int    `jsonapi:"primary,authenticator-requests,omitempty" valid:"Numeric"`
    ...
    DisableMFA struct {
        ID                int                 `jsonapi:"primary,mfa-disable-requests,omitempty" valid:"Numeric"`
        Username          string              `jsonapi:"attr,username" valid:"Required;Match(/^[A-Za-z0-9]+(?:[-_.][A-Za-z0-9]+)*$/)"`
        Password          string              `jsonapi:"attr,password" valid:"Required;MinSize(6);MaxSize(100)"`
